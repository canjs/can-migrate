...
function transformer(file, api, options) {
  var debug = (0, _debug2.default)('can-migrate:can-mustache-replace:' + file.path);
  var config = (0, _getConfig2.default)(options.config);
  var j = api.jscodeshift;
  var printOptions = options.printOptions || {};
  var root = j(file.source);
  var found = false;
  var newName = config.moduleToName['can-mustache'];
  ...
  if (found) {
    _dependencyUtils2.default.add(root, 'can-mustache', newName, ['can', 'can/', 'can/can', 'can/can.js']);
  }
