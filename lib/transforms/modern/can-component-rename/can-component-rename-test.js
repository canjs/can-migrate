...
describe('can-component-rename', function () {
  ...
  it('Handles no component', function () {
    var fn = require(toTest.file);
    var inputPath = 'fixtures/modern/' + toTest.fileName.replace('.js', '-input-no-component.js');
    var outputPath = 'fixtures/modern/' + toTest.fileName.replace('.js', '-output-no-component.js');
    utils.diffFiles(fn, inputPath, outputPath);
  });
});