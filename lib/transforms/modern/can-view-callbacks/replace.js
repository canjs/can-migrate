...
function transformer(file, api, options) {
  var debug = (0, _debug2.default)('can-migrate:can-view-callbacks-replace:' + file.path);
  ...
  if (found) {
    _dependencyUtils2.default.add(root, 'can-view-callbacks', newName, ['can', 'can/can', 'can/can.js']);
  }
