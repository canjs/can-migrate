...
function transformer(file, api, options) {
  var debug = (0, _debug2.default)('can-migrate:can-isDeferred-replace:' + file.path);
  var config = (0, _getConfig2.default)(options.config);
  var j = api.jscodeshift;
  var printOptions = options.printOptions || {};
  var root = j(file.source);
  var found = false;
  var newName = config.moduleToName['can-util/js/is-promise-like/is-promise-like'];
  ...
  if (found) {
    _dependencyUtils2.default.add(root, 'can-util/js/is-promise-like/is-promise-like', newName, ['can', 'can/', 'can/can', 'can/can.js']);
  }
