 ...
 * Before:
 *   ```js 
 *   const <...> = require('can/view/import/');
 *   //OR
 *   const <...> = require('can/view/import/import');
 *   //OR
 *   const <...> = require('can/view/import/import.js');
 *   ```
 * After:
 *   ```js 
...
const debug = makeDebug('can-migrate:modern-can-view-import-require');
