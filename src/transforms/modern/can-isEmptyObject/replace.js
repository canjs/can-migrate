...
const debug = makeDebug('can-migrate:can-isEmptyObject-replace');
...
export default function transformer(file, api, options) {
  ...
  if (found) {
    dependencyUtils.add(root, 'can-util/js/is-empty-object/is-empty-object', newName, ['can', 'can/can', 'can/can.js']);
  }
