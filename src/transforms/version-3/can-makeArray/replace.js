...
export default function transformer(file, api, options) {
  const debug = makeDebug(`can-migrate:can-makeArray-replace:${file.path}`);
  ...
  if (found) {
    dependencyUtils.add(root, 'can-util/js/make-array/make-array', newName, ['can', 'can/', 'can/can', 'can/can.js']);
  }
