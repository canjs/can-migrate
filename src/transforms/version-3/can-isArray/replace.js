...
export default function transformer(file, api, options) {
  const debug = makeDebug(`can-migrate:can-isArray-replace:${file.path}`);
  ...
  if (found) {
    dependencyUtils.add(root, 'can-util/js/is-array-like/is-array-like', newName, ['can', 'can/', 'can/can', 'can/can.js']);
  }
